                            ...
                            <div class="col-lg-1" style="width: 100%;">
                                <strong class="col-lg-12 col-12 col-sm-12 d-flex justify-content-end">
                                    @auth
                                        ...
                                        <a href="/logout" method="get" class="col-1 col-sm-1 d-flex justify-content-end link-secondary text-decoration-none ">
                                            <button type="submit" class="link-secondary text-decoration-none" style="background: none; padding: 0; border: 0">
                                                <div class="col-lg-12 d-flex align-items-center">
                                                    <li class="nav-item dropdown" style="list-style: none" >
                                                        <a class="nav-link dropdown-toggle link-secondary text-decoration-none" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                            Welcome, {{Auth::user()->name}}
                                                        </a>

                                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                                            <li>
                                                                <a class="link-secondary text-decoration-none" href="/logout" method="get">
                        ...
                        <div class="collapse navbar-collapse col-lg-6" id="navbarSupportedContent">
                            ...
                            <div class="col-lg-7 d-flex align-items-center">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-between">
                                    <li class="nav-item">
                                        <a class="nav-link link-secondary text-decoration-none" aria-current="page" href="/blockcode"><strong>Block Code</strong></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link link-secondary text-decoration-none" aria-current="page" href="/webcompiler"><strong>Web Compiler</strong></a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-6 d-flex justify-content-end d-none d-lg-flex">
                            ...
                            <div class="col-lg-12 col-12 col-sm-12" >
                                <strong class="col-12 col-sm-12 d-flex justify-content-end">
                                    @auth
                                        <a class="col-lg-3 col-3 col-sm-3 d-flex justify-content-end">
                                            <button class="link-secondary text-decoration-none" style="background: none; padding: 0; border: 0">
                                                <div class="col-lg-12 d-flex align-items-center">
